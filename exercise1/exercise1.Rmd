...
![\frac{N}{P-c} = Q](https://render.githubusercontent.com/render/math?math=%5Cfrac%7BN%7D%7BP-c%7D%20%3D%20Q)
...
![ln(Q) = 4.720604 - 1.618578*ln(P)](https://render.githubusercontent.com/render/math?math=ln(Q)%20%3D%204.720604%20-%201.618578*ln(P))
...
![Q = 112.236*P^{-1.618567}](https://render.githubusercontent.com/render/math?math=Q%20%3D%20112.236*P%5E%7B-1.618567%7D)

Plugging this back into the original Net Profit equation yields

![N = (P - c)(112.236*P^{-1.618567})](https://render.githubusercontent.com/render/math?math=N%20%3D%20(P%20-%20c)(112.236*P%5E%7B-1.618567%7D))

To solve for the optimal price, the derivative 
![\frac{dN}{dP} = \frac{-69.59*(P-2.6129c)}{x^(2.62)}](https://render.githubusercontent.com/render/math?math=%5Cfrac%7BdN%7D%7BdP%7D%20%3D%20%5Cfrac%7B-69.59*(P-2.6129c)%7D%7Bx%5E(2.62)%7D)
...
![P = 2.6129*c](https://render.githubusercontent.com/render/math?math=P%20%3D%202.6129*c)
